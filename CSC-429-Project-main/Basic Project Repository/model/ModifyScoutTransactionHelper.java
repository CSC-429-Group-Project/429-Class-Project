...
public class ModifyScoutTransactionHelper extends EntityBase {
    ...
    public ModifyScoutTransactionHelper(String transactionID) throws InvalidPrimaryKeyException {
        super(tableName);
    ...
    public ModifyScoutTransactionHelper(Properties props) {
        super(tableName);
